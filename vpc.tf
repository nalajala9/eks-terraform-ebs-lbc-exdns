...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name                                           = "${var.project}_public_${data.aws_availability_zones.available.names[count.index]}"
    "kubernetes.io/cluster/${var.project}-cluster" = "shared"
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name                                           = "${var.project}_private_${data.aws_availability_zones.available.names[count.index]}"
    "kubernetes.io/cluster/${var.project}-cluster" = "shared"
